...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*VolumeMount)(nil), (*unversioned.VolumeMount)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha2_VolumeMount_To_unversioned_VolumeMount(a.(*VolumeMount), b.(*unversioned.VolumeMount), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*unversioned.VolumeMount)(nil), (*VolumeMount)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_unversioned_VolumeMount_To_v1alpha2_VolumeMount(a.(*unversioned.VolumeMount), b.(*VolumeMount), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha2_ContainerConfig_To_unversioned_ContainerConfig(in *ContainerConfig, out *unversioned.ContainerConfig, s conversion.Scope) error {
	...
	out.VolumeMounts = *(*[]unversioned.VolumeMount)(unsafe.Pointer(&in.VolumeMounts))
	return nil
}
...
func autoConvert_v1alpha2_VolumeMount_To_unversioned_VolumeMount(in *VolumeMount, out *unversioned.VolumeMount, s conversion.Scope) error {
	out.Name = in.Name
	out.VolumeSource = in.VolumeSource
	return nil
}

// Convert_v1alpha2_VolumeMount_To_unversioned_VolumeMount is an autogenerated conversion function.
func Convert_v1alpha2_VolumeMount_To_unversioned_VolumeMount(in *VolumeMount, out *unversioned.VolumeMount, s conversion.Scope) error {
	return autoConvert_v1alpha2_VolumeMount_To_unversioned_VolumeMount(in, out, s)
}

func autoConvert_unversioned_VolumeMount_To_v1alpha2_VolumeMount(in *unversioned.VolumeMount, out *VolumeMount, s conversion.Scope) error {
	out.Name = in.Name
	out.VolumeSource = in.VolumeSource
	return nil
}

// Convert_unversioned_VolumeMount_To_v1alpha2_VolumeMount is an autogenerated conversion function.
func Convert_unversioned_VolumeMount_To_v1alpha2_VolumeMount(in *unversioned.VolumeMount, out *VolumeMount, s conversion.Scope) error {
	return autoConvert_unversioned_VolumeMount_To_v1alpha2_VolumeMount(in, out, s)
}
